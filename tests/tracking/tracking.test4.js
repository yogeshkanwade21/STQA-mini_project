...
async function example() {
  ...
  var prodNameOrderPage = await driver.findElement(By.className("prod-1")).getText();
  console.log('Product:',prodNameOrderPage);

  let btnClicked = await driver.findElement(By.id("product-1")).getText();
